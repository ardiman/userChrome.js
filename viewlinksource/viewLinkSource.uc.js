...
// @description    Link-Quellentext mit, Mittelklick in neuem Tab öffnen, Rechtsklick in Seitenleiste öffnen
// @include        main
...
var viewLinkSource = {
  ...
  init: function() {
    ...
    menuitem.setAttribute("label","Link-Quellentext anzeigen");
