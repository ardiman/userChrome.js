...
location == "chrome://browser/content/browser.xul" && (function () {
	var undoCloseMenu = document.getElementById('tabContextMenu').insertBefore(document.createElement('menu'), null);
	undoCloseMenu.setAttribute('label', 'Kürzlich geschlossene Tabs');  //'\u6700\u8fd1\u9589\u3058\u305f\u30bf\u30d6'
