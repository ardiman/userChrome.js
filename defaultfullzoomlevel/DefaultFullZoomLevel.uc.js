...
var FullZoomConfig = new function () {
    //Die Standard-Zoom-Stufe
	this.defaultLv = 100;
	//TextZoom 
	this.Textmode = false;
	//Ob es für lokale Dateien verwendet werden soll
	...
	//Änderung in der Sidebar, Neuberechnung des Zooms
	this.reserveSidebarWidth = true;
	//Automatische Fensteranpassung, Höchstwert
	this.maximum = 300;
	//Automatische Fensteranpassung, Mindestwert
	this.minimum = 30;
	//BilderZoom ignorieren
...
var fullZoomBtn = {
	...
	SetFullZoom : function (event, zoom, useFullZoom) {
		if (event.button == 0)
			...
			alertsService.showAlertNotification("chrome://global/skin/icons/information-32.png", "DefaultFullZoomLevel", "Alle Seiten wurden auf Standardwerte skaliert" + zoom * 100 + "%", false, "", null, "");
		}
	},
	...
	onPopupShowing : function (event, useFullZoom) {
		...
		for (var i = 0; i < arr.length; i++) {
			...
			menuitem.setAttribute('tooltiptext',"Linke Maustaste für Zoomfaktor der aktuellen Seite, rechten Maustaste für die Standardeinstellung  aller Seiten");
...
function fullZoomUI() {
	...
	button.setAttribute("tooltiptext", "Linke Maustaste auf das Symbol, um zwischen Seiten -oder nur Text-Modus zu wechseln, mit der rechten Maustaste auf das Symbol für das Menü");
