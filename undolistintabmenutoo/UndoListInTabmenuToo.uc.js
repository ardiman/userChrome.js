...
;
  ...
  makePopup: function(popup, refItem, id){
    ...
    if (this.getVer() > 3.0) {
      ...
      menu.setAttribute("label", "K�rzlich geschlossene Fenster");
    ...
    const LABELTEXT = locale.indexOf("ja") == -1?"K�rzlich geschlossene Tabs":"\u6700\u8fd1\u9589\u3058\u305f\u30bf\u30d6";    //create menu
    menu = document.createElement("menu");
  ...
  populateUndoSubmenu3: function(undoPopup) {
    ...
    m = undoPopup.appendChild(document.createElement("menuitem"));
    m.setAttribute("label", "Liste der letzten Tabs l�schen");
