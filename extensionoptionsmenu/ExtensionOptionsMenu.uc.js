...
// @description		拡張の設定ダイアログを開くボタンを追加する
//				メニュー内の拡張を右クリックで有効/無効をトグル
//				メニュー内の拡張をctrl+右クリックでアンインストール
//				メニュー内の拡張をctrl+左クリックでアドオンのxpiを選択した状態でExtensionsフォルダを開く
//				メニュー内の拡張を中クリックでアドオンのホームページを開く
//				アイコンを右クリックでアドオンマネージャを開く
// @author			hiyoko
...
// @version		2.3	ctrl+ Linksklick auf ein Addon aus dem Menü öffnet dessen Installationsordner
//				ツールチップにアドオンのidを表示するように変更
// ==/UserScript==
